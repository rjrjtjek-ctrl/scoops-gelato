...
const faqData = [
  ...
  },
  {
    ...
    a: "15평 기준 약 7,000만원 내외입니다. 가맹비, 보증금, 인테리어, 장비, 초도물량 등이 포함됩니다. 매장 규모와 지역에 따라 달라질 수 있으며, 자세한 비용은 개설비용 페이지에서 확인하실 수 있습니다.",
  },
  {
    q: "매장 운영에 필요한 인력은 몇 명인가요?",
    a: "15평 기준 점주 포함 2~3명이면 운영 가능합니다. 피크 시간대에는 추가 인력이 필요할 수 있으며, 본사에서 효율적인 인력 운영 방안을 안내해 드립니다.",
  },
  {
